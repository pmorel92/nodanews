...
def node_dir_part(request, node_dir_id):
    ...
    return render(request, 'nodanews/node-dir_part.html', {'nodes': nodes, 'node_dirs': node_dirs, 'node_dir_topics': node_dir_topics, 'breaking_links': breaking_links})	
...
def node(request, node_id):
    ...
    return render(request, 'nodanews/node.html', {'node': node, 'perspectives': perspective_links, 'node_dirs': node_dirs, 'breaking_links': breaking_links})
